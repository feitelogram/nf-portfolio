...
import {
  Header, Container, Grid, Menu, Divider, Image,
  ...
  <div>
    <>
      <Menu fixed="top" fluid color="green" inverted widths={5}>
        ...
        <Menu.Item
          as="a"
          href="mailto:nicholas.feitel@gmail.com"
          content="Contact Nic"
          target="_blank"
        ...
        <Menu.Item
          as="a"
          href="http://linkedin.com/in/nicholasfeitel"
          content="LinkedIn"
          target="_blank"
          rel="noopener noreferrer"
        />
        <Menu.Item
          as="a"
          href="http://github.com/feitelogram"
          content="Github"
          target="_blank"
          rel="noopener noreferrer"
        />
        <Menu.Item
          as="a"
          href="https://medium.com/@nicholas.feitel/"
          content="Medium"
          target="_blank"
          rel="noopener noreferrer"
        />
      ...
      <Grid>
        <Grid.Row>
          <Container inverted text dividing style={{ padding: '1rem' }}>
            ...
            >
              Available for full-time, part-time and contract technical projects.
            </p>
            <Divider />
        ...
        <Grid.Row dividing>
          <Container dividing style={{ padding: '2rem' }}>
            ...
            <div className="youtube-responsive-container">
              <iframe title="getBetter" width="1100" height="650" src="https://www.youtube.com/embed/AwW8sv5kK6E" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
          </Container>
        </Grid.Row>
        <Divider />
        <Grid.Row>
          <Container dividing style={{ padding: '2rem' }}>
            ...
            <div className="youtube-responsive-container">
              <iframe title="calmwithwoofers" width="1100" height="650" src="https://www.youtube.com/embed/bWAReQspa5Y" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
          </Container>
        </Grid.Row>
        <Divider />
        ...
        <Grid.Row>
          <Container dividing style={{ padding: '2rem' }}>
            <Header as="h2" textAlign="center" content="(k)Nack: A privacy-forward chat-app for talking with friends." />
        ...
        <Grid.Row>
          <Container dividing style={{ padding: '2rem' }}>
            ...
            <div className="youtube-responsive-container">
              <iframe title="learncode" width="1100" height="650" src="https://www.youtube.com/embed/N2DsRJF3Tbg" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
          </Container>
        </Grid.Row>
        <Divider />
